...
public class OWM_Actions_Test extends BrowserInvoke {
	...
	public void WorkFlowManager_Actions() throws InterruptedException {
		...
		// ----------------------------------------------------------------------------
		/*
		 * owm.fnWorkflowBrowserSearch(); Thread.sleep(2000);
		 * wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("viewIFrame"));
		 * List<WebElement> rows = driver.findElements(By.xpath(
		 * "//DIV[@id='grdWFfolders_dom']/TABLE[1]/TBODY[1]/TR"));
		 * System.out.println(rows.size()); if (rows.size() > 3) {
		 * //wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("viewIFrame")
		 * ); fm.fnWebTable(driver, driver.findElement(By.xpath(
		 * "//*[@id='grdWFfolders_dom']/table/tbody/tr[3]/td")),"Click");
		 * driver.switchTo().parentFrame(); owm.Actions();
		 * wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("viewIFrame"));
		 * lp.fnOWMActionsMenu("Delete WorkFlow(s)", ""); Thread.sleep(2000);
		 * owm.fnWorkflowAlert(driver.switchTo().alert().getText()
		 * ,"Do you want to delete these workflows?"); driver.switchTo().parentFrame();
		 * }
		 */
		...
		// new
		// WebDriverWait(driver,50).until(ExpectedConditions.numberOfWindowsToBe(2));
		wait.until(ExpectedConditions.numberOfWindowsToBe(2));
		lp.fnSwitchtoWindow(2, "WorkFlow Manager");
		 ...
		 * fm.fnWebTable(driver, driver.findElement(By.xpath(
		 * "//*[@id='grdWFfolders_dom']/table/tbody/tr[3]/td")),"Click"); owm.Actions();
		 * wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("viewIFrame"));
		 * lp.fnOWMActionsMenu("WorkFlow Properties", "");
		 * wait.until(ExpectedConditions.numberOfWindowsToBe(3));
		 * lp.fnSwitchtoWindow(3,"WorkFlow Properties"); owm.fnWorkflowProperties();
		 */
		// driver.switchTo().parentFrame();
		 ...
		 * lp.fnOWMActionsMenu("Delete WorkFlow(s)", "");
		 * owm.fnWorkflowAlert(driver.switchTo().alert().getText()
		 * ,"Do you want to delete these workflows?"); Thread.sleep(1000);
		 */
	}
