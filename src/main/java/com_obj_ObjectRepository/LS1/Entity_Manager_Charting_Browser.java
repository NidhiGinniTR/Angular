...
public class Entity_Manager_Charting_Browser extends ExtentManager{
	WebDriver driver;
	Properties template;

	
	FrameWork2 fm = new FrameWork2();
	public Entity_Manager_Charting_Browser(WebDriver driver, Properties data2, Properties propSerialData) {
		this.driver = driver;
		this.template = data2;
	}
