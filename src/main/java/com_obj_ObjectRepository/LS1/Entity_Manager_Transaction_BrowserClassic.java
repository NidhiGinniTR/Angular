...
public class Entity_Manager_Transaction_BrowserClassic extends ExtentManager {
	...
	public Entity_Manager_Transaction_BrowserClassic(WebDriver driver, Properties data2, Properties propSerialData) {
		this.driver = driver;
		this.template = data2;
	}
