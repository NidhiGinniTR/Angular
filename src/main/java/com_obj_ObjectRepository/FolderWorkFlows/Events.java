...
public class Events {
		...
		// ---------------Schedule New Events Page1-----------------------------------------------------------------------------
			...
			By fwf_Events_SNE_Cancel = By.xpath("//INPUT[@id='btnCancel']");
			...
			public void fwf_Events_SNE_Cancel() throws InterruptedException {
				fm.fnWebButton(driver, fwf_Events_SNE_Cancel, "Cancel");
			}
			...
			By fwf_Events_SNE_Next2 = By.xpath("//IMG[@id='imgNextEvent']");
			By fwf_Events_SNE_Previous = By.xpath("//IMG[@id='imgPreviousEvent']");
			By fwf_Events_SNE_Cancel2 = By.xpath("//IMG[@id='Image2']");
			...
			By fwf_Events_SNE_Next3 = By.xpath("//IMG[@id='imgNextResp']");
			By fwf_Events_SNE_Cancel3 = By.xpath("//IMG[@id='Img5']");
