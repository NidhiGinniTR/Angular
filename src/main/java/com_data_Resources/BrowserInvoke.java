...
public class BrowserInvoke {
    ...
    public   WebDriver InvokeDriver() throws IOException {
    	...
    	//InputStream stream =getClass().getResourceAsStream("environmentFile.properties");
    	FileInputStream data = new FileInputStream(".\\src\\main\\java\\resources\\newFolderdata.properties");
    	FileInputStream paralleldata = new FileInputStream(".\\src\\main\\java\\resources\\paralleltemplatedata.properties");
    	FileInputStream launchandLogin = new FileInputStream(".\\src\\main\\java\\resources\\environmentFile.properties");
